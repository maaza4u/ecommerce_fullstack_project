...
const SingleProduct = () => {
    const [quantity,setQuantity] = useState(1);
      const {id} = useParams();  //This 'id' was taken from app.js Route 
      const {data} = useFetch(`/api/products?populate=*&[filters][id]=${id}`) //calling api from strapi of products,filters , go to documentation strapi
        ...
        <div className="layout">
            <div className="single-product-page">
                ...
                <div className="right">
                   ...
                   {/* &#8377 code is used for symbol rupee */}
